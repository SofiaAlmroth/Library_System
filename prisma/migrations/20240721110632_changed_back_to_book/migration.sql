/*
  ...
  - The values [NOVEL] on the enum `BookType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "BookType_new" AS ENUM ('DVD', 'BOOK', 'AUDIOBOOK', 'ENCYCLOPEDIA');
